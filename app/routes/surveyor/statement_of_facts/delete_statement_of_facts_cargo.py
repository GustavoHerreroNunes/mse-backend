...
@statement_of_facts_bp.route('/cargo/<int:event_id>', methods=['DELETE'])
def delete_statement_of_facts_cargo(event_id):
    """Delete statement of facts cargo by event_id"""
    ...
    try:
        ...
        current_session.execute(
            text("DELETE FROM tbl_statement_cargo WHERE event_id = :id"),
            {"id": event_id}
        )
