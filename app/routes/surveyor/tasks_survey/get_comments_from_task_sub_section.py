...
@tasks_survey_bp.route('/boarding/comments/task/<int:task_id>/section/<int:section_index>/subsection/<int:subsection_index>', methods=['GET'])
def get_comments_from_task_sub_section(task_id, section_index, subsection_index):
