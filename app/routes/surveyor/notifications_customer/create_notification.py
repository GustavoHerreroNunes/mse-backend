...
@notifications_customer_bp.route('/', methods=['POST'])
    ...
    try:
        ...
        try:
            ...
            result = current_session.execute(
                text("INSERT INTO tbl_notification_customer (id_task, id_customer, message, created_at, is_read, title) "
                    "VALUES (:id_task, :id_customer, :message, :created_at, :is_read, :title) "
